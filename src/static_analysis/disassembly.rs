...
pub fn disassemble_binary(file_path: &str, count: u32, verbose: bool) -> Result<String, Box<dyn std::error::Error>> {
    info!("Starting disassembly of {} ({} instructions)", file_path, count);
